...
// To cache the calculated similarity, concrete Deltas can use similariter and similarityCache
...
func (cache similarityCache) Similarity() float64 {
	if cache.value < 0 {
...
// Deltas implements this interface should be applied before PostDeltas.
...
// PostDelta A PreDelta is a Delta that has a position of the right side JSON object.
// Deltas implement this interface should be applied after PreDeltas.
...
func (d *Object) similarity() float64 {
	return deltasSimilarity(d.Deltas)
}
...
func (d *Modified) PostApply(object interface{}) interface{} {
	...
	case []interface{}:
		object.([]interface{})[d.PostPosition().(Index)] = d.NewValue
	}
	return object
}
...
// Deleted A Deleted represents deleted field or index of an Object or an Array.
type Deleted struct {
	preDelta
	// The value deleted
	Value interface{}
...
func (d Deleted) Similarity() float64 {
	return 0
}
