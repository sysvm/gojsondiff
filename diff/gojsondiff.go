...
import (
	...
	"github.com/sysvm/golcs"
)

// Diff holds deltas generated by a Differ
type Diff interface {
...
func (differ *Differ) Compare(left, right []byte) (Diff, error) {
...
func (differ *Differ) compareMaps(left map[string]interface{}, right map[string]interface{}) []Delta {
	deltas := make([]Delta, 0)
...
func (differ *Differ) compareArrays(left []interface{}, right []interface{}) []Delta {
	deltas := make([]Delta, 0)
	// LCS index pairs
	lcsPairs := golcs.New(left, right).IndexPairs()
...
func (differ *Differ) compareValues(position Position, left interface{}, right interface{}) (bool, Delta) {
...
func (differ *Differ) maximizeSimilarities(left []maybe, right []maybe) ([]Delta, []maybe, []maybe) {
