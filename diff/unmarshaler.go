...
func (u *Unmarshaler) UnmarshalBytes(diffBytes []byte) (Diff, error) {
	var diffObj map[string]interface{}
	json.Unmarshal(diffBytes, &diffObj)
	return u.UnmarshalObject(diffObj)
}

func (u *Unmarshaler) UnmarshalString(diffString string) (Diff, error) {
	return u.UnmarshalBytes([]byte(diffString))
}

func (u *Unmarshaler) UnmarshalReader(diffReader io.Reader) (Diff, error) {
	var diffBytes []byte
	io.ReadFull(diffReader, diffBytes)
	return u.UnmarshalBytes(diffBytes)
}

func (u *Unmarshaler) UnmarshalObject(diffObj map[string]interface{}) (Diff, error) {
