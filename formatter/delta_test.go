...
var _ = ginkgo.Describe("Delta", func() {
	ginkgo.Describe("Format", func() {
		var (
			a, b map[string]interface{}
		)

		ginkgo.Context("There are no difference between the two JSON strings", func() {
			ginkgo.It("Returns empty JSON", func() {
				...
				gomega.Expect(deltaJson).To(gomega.Equal(map[string]interface{}{}))
			})
		})
		...
		ginkgo.Context("There are long texts", func() {
			ginkgo.It("Returns empty JSON", func() {
